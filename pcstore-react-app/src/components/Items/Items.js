...
{props.items.map((item,i) =>{
  return(
   <div key={i} className="item">
    ...
    <Card  sx={{boxShadow:2, display:"flex" ,flexDirection:"column",justifyContent:"center", maxWidth: 245,minWidth:245,marginRight:'10px' }}>
     <Box sx={{ display:"flex" ,height:"14rem" ,justifyContent:"center"
     ...
     ,padding:"0.2rem"
      ...
      <CardContent sx={{display:"flex" ,flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
        <Typography alignContent={'center'} variant="subtitle2" color="">
