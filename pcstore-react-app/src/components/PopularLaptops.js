...
useEffect(() => {
  try {
    axios.get('http://localhost:4000/get-products?order=-1&page=1&limit=10&sortBy=price').then((response) => {
  ...
  return (
    <Box sx={{backgroundColor:"#fff",paddingTop:'1rem',height:'auto' }}>
        <Typography sx={{paddingLeft:'1rem'}} variant='h5'>Popular Laptops</Typography>
